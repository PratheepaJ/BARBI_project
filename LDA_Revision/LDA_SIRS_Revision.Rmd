...
p.all.blocks[[1]]
ggsave("./Figures/SIRS_LDA_theta_set1.eps", plot = p.all.blocks[[1]], width = 10, height = 7)
```


```{r fig.width=15, fig.height=10}
p.all.blocks[[2]]
ggsave("./Figures/SIRS_LDA_theta_set2.eps", plot = p.all.blocks[[2]], width = 10, height = 7)
```

```{r fig.width=15, fig.height=10}
p.all.blocks[[3]]
ggsave("./Figures/SIRS_LDA_theta_set3.eps", plot = p.all.blocks[[3]], width = 10, height = 7)
```
...
# max.beta.in.each.asv.all.topics.all.blocks = lapply(max.beta.in.each.asv.all.topics.all.blocks, function(x){
#   x$Genus = substring(x$Genus, 4) %>% as.factor()
#   return(x)
# })

# max.beta.in.each.asv.all.topics.all.blocks = lapply(max.beta.in.each.asv.all.topics.all.blocks, function(x){
#   x$Family = substring(x$Family, 4) %>% as.factor()
#   return(x)
# })
```
...
ggsave("./Figures/SIRS_Set1_ASV.png", p_cloud_all_blocks[[1]], width = 22, height = 10, units = "in", dpi = 300)
```

```{r fig.width=15, fig.height=10}
p_cloud_all_blocks[[2]]
ggsave("./Figures/SIRS_Set2_ASV.png", p_cloud_all_blocks[[2]], width = 12, height = 7, units = "in", dpi = 300)
```

```{r fig.width=15, fig.height=10}
p_cloud_all_blocks[[3]]

ggsave("./Figures/SIRS_Set3_ASV.png", p_cloud_all_blocks[[3]], width = 12, height = 7, units = "in", dpi = 300)
```
