...
saveRDS(gammaPrior_posTrueSing_all_blocks, file= "./Results/gammaPrior_posTrueSing_all_blocks__mock.rds")
```
...
burnIn <- 5000
cov_pro <- .95
mak_tab <- FALSE # need to change to TRUE if you want to make tables
#psByBlock <- readRDS("./Results_BARBI_8_28_18/psByBlock.rds")
num_blks <- length(psByBlock)

gammaPrior_posTrueSing_all_blocks <- readRDS("./Results/gammaPrior_posTrueSing_all_blocks__mock.rds")
