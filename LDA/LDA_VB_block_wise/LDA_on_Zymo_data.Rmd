...
We identifed 142 ASVs not is any dilution series samples and they are classified as contaminants before using LDA.
...
We reduced the number of topics less than 10. We have 10 negative control samples so let us choose K =5.
...
### Posterior distirbution of topic in each sample 
...
Topics 2 and 3 contains most of real species (green and red). Topic 4 is mix of both real and contaminant species. Topics 1, 3, and 5 are contaminant species.
...
### Topic distrirbution summary in negative controls
