...
```{r}
p.all.blocks[[1]]
ggsave("./Figures/LDA_HF_set1_boxplot_col.eps", plot = p.all.blocks[[1]], width = 9, height = 6)
```


```{r}
p.all.blocks[[2]]
ggsave("./Figures/LDA_HF_set2_boxplot_col.eps", plot = p.all.blocks[[2]], width = 9, height = 6)
```
