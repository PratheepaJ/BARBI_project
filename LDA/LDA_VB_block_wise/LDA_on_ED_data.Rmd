...
```{r}
p.all.blocks[[1]]
ggsave("./Figures/LDA_ED_set1_boxplot.eps", plot = p.all.blocks[[1]], width = 9, height = 6)
```


```{r}
p.all.blocks[[2]]
ggsave("./Figures/LDA_ED_set2_boxplot.eps", plot = p.all.blocks[[2]], width = 9, height = 6)
```

```{r}
p.all.blocks[[3]]
ggsave("./Figures/LDA_ED_set3_boxplot.eps", plot = p.all.blocks[[3]], width = 9, height = 6)
```
